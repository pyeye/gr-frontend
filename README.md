...
This command serves the app at `http://178.62.212.17:8080` and provides basic URL
routing for the app:
...
This command serves the minified version of the app at `http://178.62.212.17:8080`
